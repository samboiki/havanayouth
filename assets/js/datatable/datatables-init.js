    ...
    return {
        init: function () {
            ...
            function fnFormatDetails(oTable, nTr) {
                ...
                var sOut = '<table>';
                sOut += '<tr><td rowspan="5" style="padding:0 10px 0 0;">'+ aData[7] +'</td><td>Name:</td><td>' + aData[1] + '</td></tr>';
                sOut += '<tr><td>Surname:</td><td>' + aData[2] + '</td></tr>';
                sOut += '<tr><td>Cellphone:</td><td>' + aData[3] + '</td></tr>';
                sOut += '<tr><td>Gender:</td><td>' + aData[4] + '</td></tr>';
    ...
    return {
        init: function () {
            ...
            function fnFormatDetails(oTable, nTr) {
                ...
                sOut += '<tr><td>Genger:</td><td>' + aData[4] + '</td></tr>';
                sOut += '<tr><td>Others:</td><td><a href="">Personal WebSite</a></td></tr>';
                sOut += '</table>';
                return sOut;
            }
