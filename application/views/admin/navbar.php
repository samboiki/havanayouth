            ...
            <div class="navbar-container">
                ...
                <div class="navbar-header pull-left">
                    <a href="#" class="navbar-brand">
                        <small>
                            <h5><strong>NMRC ADMIN PANEL</strong></h5>
                        </small>
                    </a>
                </div>
                <!-- /Navbar Barnd -->
                        ...
                        <ul class="account-area">
                            ...
                            <li>
                                <a class="login-area dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <section>
                                        <h2><span class="profile"><span>Odilo Sikopo</span></span></h2>
                                    </section>
                                </a>
                                <!--Login Area Dropdown-->
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                                    <li class="username"><a>Odilo Sikopo</a></li>
                                    <li class="email"><a>Odilo.Sikopo@live.com</a></li>
                                    <!--Avatar Area-->
                                    <li>
