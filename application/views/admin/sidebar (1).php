                ...
                <ul class="nav sidebar-menu">
                    <!--Dashboard-->
                    <li class="<?php $link = $this->uri->segment(1); 
                          if($link == "administrator"){
                            echo 'active';  
                          } else {
                            echo '';  
                          }
                    ?>"><a href="<?php echo base_url('administrator');?>"><i class="menu-icon glyphicon glyphicon-home"></i>
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <li class="<?php echo active_link('active'); ?>"><a href="<?php echo base_url('tables');?>">
