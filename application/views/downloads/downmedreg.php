        ...
        <div class="content container">
            <div class="page-wrapper">
                <header class="page-heading clearfix">
                    <h4 class="heading-title pull-left">Medicine Registration Downloads</h4>
                    <div class="breadcrumbs pull-right">
                        <ul class="breadcrumbs-list">
                            <li class="breadcrumbs-label">You are here:</li>
                            <li><a href="index.html">Home</a><i class="fa fa-angle-right"></i></li>
                            <li><a href="index.html">Downloads</a><i class="fa fa-angle-right"></i></li>
                            <li class="current">Medicine Registration</li>
                        </ul>
                    </div><!--//breadcrumbs-->
                </header>
                        ...
                        <article class="courses-wrapper col-md-8 col-sm-7"> 
                            <div class="featured-courses tabbed-info page-row">             
                                <ul class="nav nav-tabs">
                                  ...
                                  <li><a href="#tab3" data-toggle="tab"><h6><strong>Medicine Register</strong></h6></a></li>
                                </ul>
                                  ...
                                  <div class="tab-pane active" id="tab1">
                                      <div class="row">
                                          <?php foreach($forms as $item): echo 
                                                ...
                                                '.anchor("/download_medregforms/$item",'
                                    ...
                                    <div class="tab-pane" id="tab2">
                                        <?php foreach($guidelines as $item): echo 
                                                '<blockquote class="custom-quote">
                                                <p><i class="fa fa-file"></i>'.$item.'</p>
                                                '.anchor("/download_medregguidelines/$item",'
                                                <span class="btn btn-theme btn-xs"><i class="fa fa-download" style="color:white"></i>download</span>' ).'
                                                </blockquote>';
                                                 endforeach;
                                          ?>
                                    ...
                                    <div class="tab-pane" id="tab3">
                                        <?php foreach($register as $item): echo 
                                                '<blockquote class="custom-quote">
                                                <p><i class="fa fa-file"></i>'.$item.'</p>
                                                '.anchor("/download_medregregister/$item",'
                                                <span class="btn btn-theme btn-xs"><i class="fa fa-download" style="color:white"></i>download</span>' ).'
                                                </blockquote>';
                                                 endforeach;
                                          ?>
