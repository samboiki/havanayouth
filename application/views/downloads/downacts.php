        ...
        <div class="content container">
            <div class="page-wrapper">
                <header class="page-heading clearfix">
                    <h3 class="heading-title pull-left">Acts and Regulations Downloads</h3>
                    <div class="breadcrumbs pull-right">
                        <ul class="breadcrumbs-list">
                            <li class="breadcrumbs-label">You are here:</li>
                            <li><a href="index.html">Home</a><i class="fa fa-angle-right"></i></li>
                            <li><a href="index.html">Downloads</a><i class="fa fa-angle-right"></i></li>
                            <li class="current">Acts and Regulations</li>
                        </ul>
                    </div><!--//breadcrumbs-->
                </header>
                            ...
                            <div class="featured-courses tabbed-info page-row">             
                                ...
                                <div class="tab-content">
                                  <div class="tab-pane active" id="tab1">
                                      <div class="row">
                                          <?php foreach($acts as $item): echo 
                                                '<blockquote class="custom-quote">
                                                <p><i class="fa fa-file"></i>'.$item.'</p>
                                                '.anchor("/download_acts/$item",'
